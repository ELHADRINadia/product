      ...
      <form onSubmit={e => {
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
            ...
            <div>
              <lable className="text-sm font-medium leading-none text-gray-800" onChange={(e) => setimage(e.target.value)}>Image</lable>
              <input aria-label="enter name product" role="input" type="file" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
            </div>
            <div>
